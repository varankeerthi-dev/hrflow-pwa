...
export default function HRCommunicationsTab() {
  ...
  return <div className="module-layout-root flex h-full flex-col gap-4 pb-6 font-inter">
    <div className="module-top-surface rounded-[12px] border border-gray-100 bg-white px-4 pt-3 shadow-sm md:px-6 md:pt-4"><ModulePillTabs tabs={TABS} activeTabId={activeTab} onTabChange={(next) => { setActiveTab(next.id); setSearch(''); setStatusFilter('all') }} ariaLabel="HR Communications sections" /></div>
